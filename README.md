# BYD CRM v2.0 - Rebuilt with TypeScript

Modern, scalable Customer Relationship Management system for BYD MotorEast sales consultants.

## 🎯 Key Features

- ✅ **Consultant Isolation** - Each consultant's data is completely separate
- ✅ **Offline Support** - Work without internet, sync when online
- ✅ **Type Safety** - TypeScript for fewer bugs
- ✅ **Unlimited Storage** - IndexedDB (no 5MB limit)
